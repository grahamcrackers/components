export function TypographyDemo() {
    return (
        <div>
            <h1 className="text-4xl font-extrabold tracking-tight scroll-m-20 lg:text-5xl">The Joke Tax Chronicles</h1>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                <a href="#" className="font-medium underline text-primary underline-offset-4">
                    a brilliant plan
                </a>
            ...
            <h3 className="mt-8 text-2xl font-semibold tracking-tight scroll-m-20">The Joke Tax</h3>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
            ...
            <h3 className="mt-8 text-2xl font-semibold tracking-tight scroll-m-20">Jokester's Revolt</h3>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
            ...
            <h3 className="mt-8 text-2xl font-semibold tracking-tight scroll-m-20">The People's Rebellion</h3>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
